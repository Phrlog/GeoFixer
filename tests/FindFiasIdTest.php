...
class FindFiasIdTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testStreetError()
    {
        ...
        $this->assertFalse($this->facade->findFiasStreet($street, $city_id, false, $strict_search = true));
    }
    ...
    public function testHouseError()
    {
        $street_id = '3e0d1213-1212-4f87-bdd3-5f8ef6f6473e';
        $house = 2657;

        $this->assertFalse($this->facade->findFiasHouse($house, $street_id));
    }
